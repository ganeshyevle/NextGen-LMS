...
const CallToAction = () => {
  return (
    <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-2 md:px-0'>
    ...
    <div className='flex items-center font-medium gap-6 mt-4'>
      <button className='bg-blue-600 text-white py-3 px-10 rounded-md'>Get started </button>
